...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(7).Buffer))
    ...
    methods: {
        ...
        fetchTodos: function fetchTodos() {
            ...
            if (this.currentUser) {
                ...
                query.find().then(function (todos) {
                    ...
                    _this.todoList.id = id; // 给 todoList 这个数组对象设置 id属性
                }, function (error) {
                    console.error(error);
                });
            }
        ...
        saveTodos: function saveTodos() {
            ...
            avTodos.save().then(function (todo) {
                ...
                _this2.todoList.id = todo.id; // 把 id 挂到 this.todoList 上，否则下次就不会调用 updateTodos 了
                console.log('保存成功');
            }, function (error) {
                console.log('保存失败');
            });
